            ...
            <div class="card-header">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center  ">
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <h4 class="text-secondary">Prácticas Registradas para el Periodo {{ $periodo->descripcionperiodoacademico }}</h4></div>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($practicas as $practica)
                            <tr>
                                ...
                                <td class="m-0 p-0"><span  class="btn  m-0 p-0 border-0">{{ $practica->estudiante->nombresestudiante.' '.$practica->estudiante->apellidosestudiante}}</span></td>
                                ...
                                <td class="m-0 p-0"><span  class="btn  m-0 p-0 border-0">{{ $practica->tutore->empresa->nombreempresa}}</span></td>
                                ...
                                <td class="m-0 p-0"><span  class="btn  m-0 p-0 border-0">{{ $practica->profesor->nombresprofesor.' '.$practica->profesor->apellidosprofesor }}</span></td>
                                <td class="m-0 p-0"><span  class="btn  m-0 p-0 border-0">{{ $practica->tutore->nombretutore.' '.$practica->tutore->apellidotutore }}</span></td>
